...
# Step 1: Update README with changes
print_step "1" "Updating README.md with latest changes"
if [ ! -f "README.md" ]; then
...
print_success "README.md backed up"

# Step 2: Verify README update worked
print_step "2" "Verifying README.md update"
if [ -f "README.md" ] && [ -s "README.md" ]; then
    print_success "README.md exists and is not empty"
else
    print_error "README.md verification failed"
fi

# Step 3: Stage changes to git
print_step "3" "Staging changes to git"
...
# Step 4: Verify staging worked as expected
print_step "4" "Verifying git staging"
...
# Step 5: Commit with single-line message
...
# Step 6: Verify commit worked
print_step "6" "Verifying commit"
